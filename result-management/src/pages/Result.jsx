...
const Result = () => {
  ...
  const[examId,setExamId]=useState("")
    ...
    const getExamData = async(e) =>{
        e.preventDefault()
        try {
            const response = await axios.get(`http://localhost:8080/api/v1/student/get/exam/${reg}/${type}`)
...
const showResult=async(data)=>{
    ...
    setExamId(examId)
    const res = await axios.get(`http://localhost:8080/api/v1/student/get/mark/${examId}`);
    const respons = await axios.get(`http://localhost:8080/api/v1/student/get/rechecking/${examId}`);
  ...
  const rechecking_apply=async(e)=>{
    ...
    const res = await axios.post(`http://localhost:8080/api/v1/student/rechecking/subjects`, {subjects,collage,name:Name,reg:Reg,semistar,price:subjectprice,semistarID:ditails._id} )
    ...
    var options = {
      ...
      handler:async function (response){
       ...
       semistarID:ditails._id
        ...
        const res = await axios.post(`http://localhost:8080/api/v1/student/varify/payment`,body)
